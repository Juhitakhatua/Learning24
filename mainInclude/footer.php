 ...
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2022 || Designed By Learning24 || <?php   
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick="clearLoginWithStatus()">Cancel</button>
          </div>
        </div>
      </div>
    </div> <!-- End Student Login Modal -->

    <!-- Start Teacher Registration Modal -->
    <div class="modal fade" id="teaRegModalCenter" tabindex="-1" role="dialog" aria-labelledby="teaRegModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="teaRegModalCenterTitle">Teacher Registration</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="clearAllteaReg()">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <!--Start Form Registration-->
            <?php include('teacherRegistration.php'); ?>
            <!-- End Form Registration -->
          </div>
          <div class="modal-footer">
            <span id="successMsg"></span>
            <button type="button" class="btn btn-primary" id="signup" onclick="addtea()">Sign Up</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="clearAllteaReg()">Close</button>
          </div>
        </div>
      </div>
    </div> <!-- End Teacher Registration Modal -->

    <!-- Start Teacher Login Modal -->
    <div class="modal fade" id="teaLoginModalCenter" tabindex="-1" role="dialog" aria-labelledby="teaLoginModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="teaLoginModalCenterTitle">Teacher Login</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onClick="clearteaLoginWithStatus()">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form role="form" id="teaLoginForm">
              <div class="form-group">
                <i class="fas fa-envelope"></i><label for="teaLogEmail" class="pl-2 font-weight-bold">Email</label><small id="teastatusLogMsg1"></small><input type="email"
                    class="form-control" placeholder="Email" name="teaLogEmail" id="teaLogEmail">
                </div>
                <div class="form-group">
                  <i class="fas fa-key"></i><label for="teaLogPass" class="pl-2 font-weight-bold">Password</label><input type="password" class="form-control" placeholder="Password" name="teaLogPass" id="teaLogPass">
              </div>
            </form>
          </div>
          <div class="modal-footer">
            <small id="teastatusLogMsg"></small>
            <button type="button" class="btn btn-primary" id="teaLoginBtn" onclick="checkteaLogin()">Login</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick="clearteaLoginWithStatus()">Cancel</button>
          </div>
        </div>
      </div>
