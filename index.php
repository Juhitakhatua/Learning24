...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to Learning24</h1>
    ...
    <div class="container-fluid bg-dark txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          ...
          <div class="col-sm">
            <h5><i class="fas fa-rupee-sign mr-3"></i> Best Price</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Learning24 provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Learning24 Pvt Ltd <br> Raza Bazar <br> Haldia,Purba Medinipur<br>West Bangal,Pin-721101<br> Ph. +000000000 </p>
          </div>
        </div>
      </div>
    </div> 
