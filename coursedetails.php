...
?>  
    ...
    <div class="container mt-5"> <!-- Start All Course -->
      <?php
          ...
          $s="SELECT tea_id from course where course_id=$course_id";
          $r=$conn->query($s);
  while ($row1 = $r->fetch_assoc()) {
    $teaId=$row1['tea_id'];
  }
          $s="SELECT tea_name from teacher where tea_id=$teaId";
          $r=$conn->query($s);
  while ($row1 = $r->fetch_assoc()) {
    $teaName=$row1['tea_name'];
  }
              ...
              echo ' 
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text"> Mentor: '.$teaName.'</p>
