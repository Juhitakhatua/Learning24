...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top p-0 shadow" style="background-color: #225470;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="adminDashboard.php">Learning24 <small class="text-white">Admin Area</small></a> 
 </nav>
   ...
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'catagory') {echo 'active';} ?>" href="catagory.php">
        <i class="fab fa-accessible-icon"></i>
        Course Catagory
       </a>
      </li>
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'teacher') {echo 'active';} ?>" href="teacher.php">
        <i class="fas fa-users"></i>
        Teachers
       </a>
      </li>
